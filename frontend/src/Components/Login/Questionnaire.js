...
function Questionnare(){
    ...
    const handleQuestionnaireForm = (event) => {
        ...
        axios.post('https://vcppt3bosrxwgftlco224dgsuy0fnhvd.lambda-url.us-east-1.on.aws/questionnaire/validateAnswers', obj)  // call aws lmabda function to validate answers
            .then(response => {
